...
/* Choose regular route when multiple route is avaliable */
const MATCH_ROUTE_OVERRIDE = [
    { company: COMPANY.NLB.CODE, route: '1', ignore: ['經'] },
    { company: COMPANY.CTB.CODE, route: '1', ignore: ['不經'] },
    ...
    { company: COMPANY.CTB.CODE, route: '106P', ignore: ['經'] },
    ...
    { company: COMPANY.CTB.CODE, route: '118', count: 4, ignore: ['柴灣'] },
    { company: COMPANY.NLB.CODE, route: '11A', ignore: ['經'] },
    { company: COMPANY.CTB.CODE, route: '15', ignore: ['經', '交易廣場'] },
    { company: COMPANY.CTB.CODE, route: '170', ignore: ['經'] },
    { company: COMPANY.CTB.CODE, route: '171', ignore: ['經'] },
    { company: COMPANY.CTB.CODE, route: '18X', count: 11, ignore: ['柴灣'] },
    { company: COMPANY.CTB.CODE, route: '20A', ignore: ['經'] },
    { company: COMPANY.CTB.CODE, route: '25', ignore: ['經'] },
    { company: COMPANY.CTB.CODE, route: '260', count: 4, ignore: ['赤柱監獄'] },
    { company: COMPANY.KMB.CODE, route: '272A', stopThreadshold: 50 },
    { company: COMPANY.KMB.CODE, route: '278K', scoreMultiplier: 2 },
    { company: COMPANY.CTB.CODE, route: '307P', count: 7, ignore: ['富蝶'] },
    { company: COMPANY.NLB.CODE, route: '3M', ignore: ['經'] },
    { company: COMPANY.CTB.CODE, route: '4', count: 6, ignore: ['假期', '田灣', '經'] },
    { company: COMPANY.NLB.CODE, route: '4', ignore: ['經'] },
    { company: COMPANY.CTB.CODE, route: '40P', count: 16, ignore: ['深灣', '香港仔'] },
    { company: COMPANY.CTB.CODE, route: '41A', ignore: ['經'] },
    { company: COMPANY.CTB.CODE, route: '48', count: 3, ignore: ['海洋公園'] },
    { company: COMPANY.CTB.CODE, route: '55', count: 10, ignore: ['經'] },
    { company: COMPANY.CTB.CODE, route: '5B', count: 6, ignore: ['銅鑼灣', '不經'] },
    { company: COMPANY.CTB.CODE, route: '606', ignore: ['經'] },
    { company: COMPANY.CTB.CODE, route: '606X', count: 6, ignore: ['啟業'] },
    { company: COMPANY.CTB.CODE, route: '63', count: 4, ignore: ['赤柱監獄'] },
    { company: COMPANY.CTB.CODE, route: '680', ignore: ['經'] },
    { company: COMPANY.CTB.CODE, route: '690', ignore: ['經'] },
    { company: COMPANY.CTB.CODE, route: '6X', count: 9, ignore: ['赤柱監獄', '赤柱炮台'] },
    { company: COMPANY.CTB.CODE, route: '7', ignore: ['經'] },
    { company: COMPANY.CTB.CODE, route: '70', ignore: ['經'] },
    { company: COMPANY.CTB.CODE, route: '722', ignore: ['中環碼頭'] },
    { company: COMPANY.CTB.CODE, route: '73', count: 4, ignore: ['赤柱監獄', '華富'] },
    { company: COMPANY.KMB.CODE, route: '74K', scoreMultiplier: 2 },
    { company: COMPANY.CTB.CODE, route: '720', ignore: ['循環線'] },
    { company: COMPANY.CTB.CODE, route: '720A', count: 4, ignore: ['畢打街'] },
    { company: COMPANY.CTB.CODE, route: '76', count: 13, ignore: ['石排灣'] },
    { company: COMPANY.CTB.CODE, route: '788', ignore: ['經', '停'] },
    { company: COMPANY.KMB.CODE, route: '78A', count: 1 },
    { company: COMPANY.CTB.CODE, route: '790', ignore: ['經'] },
    { company: COMPANY.CTB.CODE, route: '795X', ignore: ['經'] },
    { company: COMPANY.CTB.CODE, route: '798X', ignore: ['經'] },
    { company: COMPANY.CTB.CODE, route: '85A', count: 7 },
    { company: COMPANY.CTB.CODE, route: '91', count: 5, ignore: ['海怡半島'] },
    { company: COMPANY.CTB.CODE, route: '93', count: 4, ignore: ['海怡半島'] },
    { company: COMPANY.CTB.CODE, route: '93C', count: 8, ignore: ['田灣'] },
    { company: COMPANY.CTB.CODE, route: '930', count: 9, ignore: ['愉景新城'] },
    { company: COMPANY.CTB.CODE, route: '952P', count: 8, ignore: ['掃管笏', '黃金海岸'] },
    { company: COMPANY.CTB.CODE, route: '95C', count: 6, ignore: ['香港仔', '工業區'] },
    { company: COMPANY.CTB.CODE, route: '962', ignore: ['經'] },
    { company: COMPANY.CTB.CODE, route: '969', count: 4, ignore: ['天恩邨'] },
    { company: COMPANY.CTB.CODE, route: '969B', count: 6, ignore: ['天水圍站', '樂湖居'] },
    { company: COMPANY.CTB.CODE, route: '970X', count: 4, ignore: ['經', '田灣'] },
    { company: COMPANY.CTB.CODE, route: '973', ignore: ['經'] },
    { company: COMPANY.CTB.CODE, route: '980X', count: 7, ignore: ['西沙'] },
    { company: COMPANY.CTB.CODE, route: '982X', count: 4, ignore: ['經', '水泉澳'] },
    { company: COMPANY.CTB.CODE, route: 'A12', ignore: ['經'] },
    { company: COMPANY.CTB.CODE, route: 'A22', ignore: ['經'] },
    { company: COMPANY.CTB.CODE, route: 'A26', ignore: ['經'] },
    { company: COMPANY.CTB.CODE, route: 'A28', ignore: ['經'] },
    { company: COMPANY.CTB.CODE, route: 'A29', ignore: ['經'] },
    { company: COMPANY.NLB.CODE, route: 'A35', ignore: ['經'] },
    { company: COMPANY.CTB.CODE, route: 'B3', ignore: ['停'] },
];
const NON_CIRCULAR_ROUTE = [
    { company: COMPANY.CTB.CODE, route: '14' },
    { company: COMPANY.CTB.CODE, route: '720' },
];
const CIRCULAR_ROUTE_ENABLE_FUTURE_STOP_CHECK = [
    { company: COMPANY.CTB.CODE, route: '110' },
    { company: COMPANY.CTB.CODE, route: '12A' },
    { company: COMPANY.KMB.CODE, route: '26M' },
